        ...
        <div className='flex flex-col items-start gap-24 col-span-5'>
            ...
            <div className='flex gap-8 flex-wrap justify-centder md:justify-start '>
                <TitleIconText
                    color='#FF6565'
                    icon={
                        <svg className='h-12 md:h-16' viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <TitleIconText
                    color='#FFBB0C'
                    icon={
                        <svg className='h-12 md:h-16' viewBox="0 0 49 48" fill="none"  >
                ...
                <TitleIconText
                    color='#5C07ED'
                    icon={
                        <svg className='h-12 md:h-16' viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='text-xl font-medium text-black text-cendter md:text-left leading-relaxed'>
                PageBot is a <span className='font-bold'>GPT powered chatbot</span> that <span className='font-bold'>understands </span>
                your website's content and <span className='font-bold'>knowledge base</span>
            </p>
        </div>

        <div className='rounded-2xl  bg-white pl-24 pt-24  flex items-end justify-center h-[70vh] w-screen  '>
            <div
                style={{
