        ...
        <div className='flex flex-col items-start gap-24 col-span-5'>
            ...
            <div className='flex gap-8 flex-wrap justify-centder md:justify-start '>
                <TitleIconText
                    color='#FF6565'
                    icon={
                        <svg className='h-8 md:h-16' viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <TitleIconText
                    color='#FFBB0C'
                    icon={
                        <svg className='h-8 md:h-16' viewBox="0 0 49 48" fill="none"  >
                ...
                <TitleIconText
                    color='#5C07ED'
                    icon={
                        <svg className='h-8 md:h-16' viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='text-xl font-normal text-black text-cendter md:text-left leading-relaxed'>
                PageBot is a <span className='text-purple'>GPT powered chatbot</span> that <span className='text-purple'>understands </span>
                your website's content and <span className='text-purple'>knowledge base</span>
            </p>
        </div>
        <div className='w-full h-[70vh] bg-center md:bg-right'
            style={{
                // height: '',
